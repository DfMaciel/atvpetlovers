...
export default class FormularioAdicaoPet extends Component<props> {
        ...
        return (
            <div className="container-fluid">
                <form>
                    ...
                    <div className="input-group mb-3">
                        <InputMask mask="999.999.999-99" className="form-control" value={this.props.cliente.cpf.numero} placeholder="CPF do Cliente" aria-label="CPF do cliente" aria-describedby="basic-addon1" disabled/>
                    </div>
                    <div className="input-group mb-3">
